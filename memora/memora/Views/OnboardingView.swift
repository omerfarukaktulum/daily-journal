...
struct PrivacyPage: View {
    var body: some View {
        VStack(spacing: 30) {
            ...
            // Shield icon with purple gradient (matching app theme)
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                PrivacyFeatureRow(
                    icon: "wifi.slash",
                    text: "No internet sync, no cloud uploads"
                )
                
                PrivacyFeatureRow(
                    icon: "eye.slash.fill",
                    text: "We never see your journal entries"
                )
                
                PrivacyFeatureRow(
                    icon: "sparkles",
                    text: "AI features optional (use your own key)"
                )
            }
            .padding(.horizontal, 40)
            
            Text("Your memories belong to you, always.")
                .font(.caption)
                .foregroundColor(.secondary)
                .italic()
                .padding(.top, 10)
