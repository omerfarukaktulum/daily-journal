...
class AIService: ObservableObject {
    ...
    init() {
        // In production, store API key securely using Keychain or environment variable
        // For now, using placeholder - user will need to add their own key
        self.apiKey = ProcessInfo.processInfo.environment["OPENAI_API_KEY"] ?? "YOUR_API_KEY_HERE"
    }
